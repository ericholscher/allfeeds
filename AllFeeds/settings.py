...
DATABASE_NAME = '/var/sqlite3/AllFeeds.db'       # Or path to database file if using sqlite3.
#DATABASE_NAME = CUR_DIR + '/dev.db'
...
ADMIN_MEDIA_PREFIX = 'http://media.ericholscher.com/admin_media/'
...
MIDDLEWARE_CLASSES = (
    ...
    'djangopeople.middleware.GetSubdomainMiddleware',
)

ROOT_URLCONF = 'AllFeeds.urls'
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    "djangopeople.context_processors.populate_subdomain",
)
...
EMAIL_DEBUG = DEBUG
CONTACT_EMAIL = "eric@ericholscher.com"
SITE_NAME = "AllFeeds"
